 ...
 */
public final class DocumentBackConfirmationFragment extends DocumentUprightConfirmationFragment {
    /**
     * 撮影を行う書類の向きを取得します.
     *
    ...
    protected Fragment getPreviousFragment() {
        final Fragment fragment = new DocumentBackCaptureTutorialFragment();
    ...
    protected FaceCropper createFaceCropper() {
        return new NullFaceCropper(this);   // 裏面には顔画像は無いので、何もしない顔切り出しオブジェクトを生成
    }
    ...
    protected Fragment getNextFragment() {
        return new SelfieTutorialFragment();
    }
